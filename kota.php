...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/project-akhir/kota.php" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Kota / Kabupaten</a>
    ...
    <header class="bg-white shadow">
        <div class="px-4 py-6 sm:px-6 lg:px-8 grid grid-cols-2">
            <div>
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Data Kota dan Kabupaten</h1>
            </div>
        ...
        <div class="px-6 py-6">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="items-center justify-center grid grid-cols-[90%_10%] w-full">
                    <div class="mr-3">
                        <input type="text" name="kota" id="" placeholder="Input Kota/Kabupaten" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="">
                        <button class="rounded-md bg-indigo-600 text-white text-sm font-bold py-3 px-4 w-full">SIMPAN DATA</button>
                    </div>
                </div>
            </form>
                ...
                <table class="md:table-auto border-Collapse border border-slate-400 w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-slate-400 bg-slate-700 text-white">Data Kota atau Kabupaten</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border border-slate-400 text-center py-2"><?php echo $w+1; ?></td>
